...
@Table(name = "tinv_item_supplier")
public class TinvItemSupplier implements Serializable {
    ...
    @JsonInclude(NON_NULL)
    @ManyToOne
    @JoinColumn(name = "isSupplierId")
    private InvSupplier isSupplierId;
    @JsonIgnore
...
@CreatedDate     @Column(nullable = true, updatable = true)     private Date createdDate;
    ...
    public InvStore getIsName() {
        return isName;
    }

    public void setIsName(InvStore isName) {
        this.isName = isName;
    }
    ...
    public InvSupplier getIsSupplierId() {
        return isSupplierId;
    }

    public void setIsSupplierId(InvSupplier isSupplierId) {
