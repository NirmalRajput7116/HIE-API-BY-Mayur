...
@Table(name = "mst_triage")
public class MstTriage implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "triageId", unique = true, nullable = true)
    private long triageId;

    @JsonInclude(NON_NULL)
    @Column(name = "triageName")
    private String triageName;

    @JsonInclude(NON_NULL)
    @Column(name = "triageCode")
