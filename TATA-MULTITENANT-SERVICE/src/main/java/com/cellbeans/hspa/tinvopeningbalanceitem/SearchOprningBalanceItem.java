...
public class SearchOprningBalanceItem {
    ...
    private int forHighRisk;
    private int forNarcotics;
    ...
    public int getForNearExpiry() {
        return forNearExpiry;
    }

    public void setForNearExpiry(int forNearExpiry) {
        this.forNearExpiry = forNearExpiry;
    }

    public int getForHighRisk() {
        return forHighRisk;
    }

    public void setForHighRisk(int forHighRisk) {
        this.forHighRisk = forHighRisk;
    }

    public int getForNarcotics() {
        return forNarcotics;
    }

    public void setForNarcotics(int forNarcotics) {
        this.forNarcotics = forNarcotics;
    }
}