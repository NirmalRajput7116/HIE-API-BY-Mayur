...
/**
 * @author Inya Gaikwad
 * This Class is responsible for Compound names of Medical drugs
 * <p>
 * Class has
 * {@link ManyToOne} with NO
 */

@Entity
@EntityListeners(AuditingEntityListener.class)
@Table(name = "inv_compound_name")
public class InvCompoundName implements Serializable {
...
@CreatedDate     @Column(nullable = true, updatable = true)     private Date createdDate;
    ...
    public void setCompoundcolor(String compoundcolor) {
