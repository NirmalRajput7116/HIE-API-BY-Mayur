...
@Table(name = "minv_dispensing")
public class MinvDispensing implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "dispensingId", unique = true, nullable = true)
    private long dispensingId;

    @JsonInclude(NON_NULL)
    @Column(name = "dispensingName")
    private String dispensingName;

    @JsonInclude(NON_NULL)
    @Column(name = "dispensingCode")
...
@CreatedDate     @Column(nullable = true, updatable = true)     private Date createdDate;
    ...
    public String getDispensingName() {
        return dispensingName;
    }

    public void setDispensingName(String dispensingName) {
        this.dispensingName = dispensingName;
    }
