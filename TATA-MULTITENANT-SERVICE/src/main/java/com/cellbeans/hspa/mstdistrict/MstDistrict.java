...
public class MstDistrict implements Serializable {
    ...
    @Column(name = "districtId", unique = true, nullable = true)
    private long districtId;

    @JsonInclude(NON_NULL)
    @ManyToOne
    @JoinColumn(name = "districtStateId")
    private MstState districtStateId;
...
@CreatedDate     @Column(nullable = true, updatable = true)     private Date createdDate;
    ...
    public MstState getDistrictStateId() {
        return districtStateId;
    }

    public void setDistrictStateId(MstState districtStateId) {
