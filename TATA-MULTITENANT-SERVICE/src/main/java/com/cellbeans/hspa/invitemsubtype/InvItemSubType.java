...
@Table(name = "inv_item_sub_type")
public class InvItemSubType implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "istId", unique = true, nullable = true)
    private long istId;
    ...
    @JsonInclude(NON_NULL)
    @ManyToOne
    @JoinColumn(name = "istTId")
    private InvItemType istTId;
...
@CreatedDate     @Column(nullable = true, updatable = true)     private Date createdDate;
    ...
    public InvItemType getIstTId() {
        return istTId;
    }

    public void setIstTId(InvItemType istTId) {
        this.istTId = istTId;
    }
