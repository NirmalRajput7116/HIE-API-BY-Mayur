...
public class SearchGRNReturnItem {
    private int offset;
    private int limit;
    ...
    private String searchGrnReturnNo;
    private long unitId;
    ...
    public String getSearchGrnReturnNo() {
        return searchGrnReturnNo;
    }

    public void setSearchGrnReturnNo(String searchGrnReturnNo) {
        this.searchGrnReturnNo = searchGrnReturnNo;
    }
